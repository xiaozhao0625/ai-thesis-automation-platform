...
from project_fact_r3.governance import (
    build_entities,
...
from project_fact_r3.extractor import extract_fixture_set
...
class ConflictAndVersionTests(unittest.TestCase):
    ...
    def test_ui_payload_is_regenerated_from_the_frozen_fixtures(self) -> None:
        ...
        candidates = [Path(configured)] if configured else [
            ROOT.parent / "prototype/project-fact-r3.json",
            ROOT.parent / "uiux-prototype/project-fact-r3.json",
        ]
